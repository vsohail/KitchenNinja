...
- (void)didLoadFromCCB {
    ...
    _ingredientList = [[NSArray alloc] initWithObjects:@"Banana", @"Strawberry", @"Pineapple", @"Onion", @"Tomato", @"Spinach", @"Pepper", @"Meat", @"Garlic", @"Cauliflower", @"Avocado", @"Cucumber", @"Brocoli", nil];
    _toxicIngredientList = [[NSArray alloc] initWithObjects:@"Shoe", @"Sock", @"Toxic", @"RottenApple", nil];
